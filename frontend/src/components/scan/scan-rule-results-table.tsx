    ...
    <>
      ...
      <ul className="divide-y divide-border md:hidden">
        {[...byCategory.entries()].map(([category, rows]) => {
          ...
          return (
            <li key={category}>
              <div className="bg-surface-subtle px-4 py-1.5">
              ...
              <ul className="divide-y divide-border">
                {rows.map((row) => (
                  <li key={row.rule_id} className={cn(
                    "px-4 py-3",
                    ...
                    <div className="mt-1.5 flex flex-wrap items-center gap-x-3 gap-y-1">
                      ...
                      <p className="text-xs text-fg-muted">{row.legal_basis}</p>
                    </div>
                    {!row.citation_verified && (
                      <span className="mt-1 inline-block rounded-sm border border-border px-1 py-0.5 text-2xs text-fg-subtle">
                        illustrative
                      </span>
                    )}
                  </li>
